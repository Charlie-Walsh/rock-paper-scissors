...
|                | Rate us modal works.                                    | Click Rate us button                                                      | Modal appears and asks for inputs in required fields if no info is provided        | N/A                                                                                                                                                                                                                         |
...
|                |                                                         |                                                                           | Added textContent to holder with appropriate win/loss condition. Still no text.    | Was linked to the div not the paragraph. Moved ID tag.                                                                                                                                                                          |
